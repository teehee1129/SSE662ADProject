...
"""
    def __init__(self,options):
        ...
        self.con = self.connect2db()
        self.getAllPatrons()
        
    def connect2db(self):
        '''
            Use psycopg2 to connect using options. Return a connection object.
        '''
        """
        ...
        #con = psycopg.connect('host=%s port=%s dbname=%s user=%s password=%s connection_timeout=10\'%(hostname, portnum, dbname, username, password))
        ...
        #con = psycopg.connect('host={} port={} dbname={} user={} password={} connection_timeout=10\'.format(hostname, portnum, dbname, username, password)
